...
distEuclidea <- dist(data_Sample[, 1:6], method = "euclidean")
```

```{r}
hclust_single2 <- hclust(distEuclidea, method = "single")
...
Again, we end up with very similar results so we can assume that the number of recommended clusters will be two again.
